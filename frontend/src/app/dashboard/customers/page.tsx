...
export default function CustomersPage() {
  ...
  return (
    <div className="workspace-page">
      ...
      <div className="wave-command-slab mb-5 !py-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0">
            <p className="workspace-section-label">Directory pulse</p>
            <p className="mt-1 text-sm text-[#475569]">Snapshot of how many profiles have real booking history versus open intake work.</p>
          </div>
          <div className="flex flex-wrap gap-2">
            ...
            <span className="inline-flex items-center rounded-full border border-amber-200 bg-amber-50 px-2.5 py-1 text-xs font-semibold text-amber-900">
              {customersNeedingAttention} open requests
            </span>
          </div>
        </div>
      </div>
