    ...
    <div className="public-marketing-root">
      ...
      <main className="marketing-container py-16 lg:py-20">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-6 text-[clamp(2.4rem,3vw,4rem)] font-semibold tracking-[-0.055em] text-app-text">
        ...
        <div className="mt-10 grid gap-4">
          {[
            ...
            <section key={title} className="panel-surface rounded-[1.9rem] p-6">
              <h2 className="text-lg font-semibold tracking-[-0.03em] text-app-text">{title}</h2>
              <p className="mt-3 text-sm leading-7 text-app-text-muted">{body}</p>
            </section>
          ))}
        </div>
      </main>
