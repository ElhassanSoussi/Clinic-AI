...
def run() -> None:
    ...
    check("no stripe sub", bs["has_stripe_subscription"] is False, bs["has_stripe_subscription"])
    ...
    check("lead not created", cr["lead_created"] is False)
    ...
    check("has_stripe_subscription", bs["has_stripe_subscription"] is True)
